...
void KWSE::Graphics::DebugUI::StaticInitialize(HWND window, bool docking, bool multiViewport)
{
	IMGUI_CHECKVERSION();
	ImGui::CreateContext();
...
void KWSE::Graphics::DebugUI::StaticTerminate()
{
...
void KWSE::Graphics::DebugUI::SetTheme(Theme theme)
{
	switch (theme)
	{
	case KWSE::Graphics::DebugUI::Theme::Classic:
	{
		ImGui::StyleColorsClassic();
		break;
	}
	case KWSE::Graphics::DebugUI::Theme::Dark:
	{
		ImGui::StyleColorsDark();
		break;
	}
	case KWSE::Graphics::DebugUI::Theme::Light:
	{
...
void KWSE::Graphics::DebugUI::BeginRender()
{
...
void KWSE::Graphics::DebugUI::EndRender()
{
	ImGui::Render();
	ImGui_ImplDX11_RenderDrawData(ImGui::GetDrawData());

	//Updated and Render additional Platform Windows
	ImGuiIO& io = ImGui::GetIO();
